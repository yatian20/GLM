# Description lawyers data Lazega <small>The following information is copied from the original data source: </small>
...
The data set is also distributed at http://elazega.fr/?page%20id=609.
...
The three networks refer to cowork, friendship, and advice. The first 36 respondents are the partners in the firm. The attribute variables include:
